...
public class MathQuestions {
        ...
        String message = "Math Questions for " + name + "\n";
            ...
            for (int i = 0; i < 5; i++) {
                ...
                if (userAnswer == correctAnswer) {
                    message += "Question " + (i + 1) + ": " + userAnswer + " is correct!\n";
                } else {
                    message += "Question " + (i + 1) + ": " + userAnswer + " is incorrect. The correct answer is " + correctAnswer + ".\n";
                }
        }
    ...
    private static void fileWriterTest(String message, String fileName) {
            try (FileWriter outStream = new FileWriter(fileName, false)) {
