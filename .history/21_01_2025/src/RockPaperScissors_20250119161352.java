...
public class RockPaperScissors {
    ...
    public static void gameLoop(JButton playerChoice, JButton loseChoice, JButton secondChoice, JFrame frame, JLabel nameLabel) {
        frame.getContentPane().removeAll();
        frame.repaint();
        ...
        Timer timer = new Timer(2500, e -> {
            JButton computerPick = showComputerChoice(playerChoice, loseChoice, secondChoice);
    ...
    public static JButton showComputerChoice(JButton playerChoice, JButton loseChoice, JButton secondChoice){
