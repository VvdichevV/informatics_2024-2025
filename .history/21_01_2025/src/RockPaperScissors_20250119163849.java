...
public class RockPaperScissors {
    ...
    public static void mainGame(JFrame frame, JLabel nameLabel) {
        ...
        rockButton.addActionListener(e -> gameLoop(rockButton, paperButton, scissorsButton, frame, nameLabel, scoreLabel));
        paperButton.addActionListener(e -> gameLoop(paperButton, scissorsButton, rockButton, frame, nameLabel, scoreLabel));
        scissorsButton.addActionListener(e -> gameLoop(scissorsButton, rockButton, paperButton, frame, nameLabel, scoreLabel));
    }
