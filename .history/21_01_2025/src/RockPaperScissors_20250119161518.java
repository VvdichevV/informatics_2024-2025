...
public class RockPaperScissors {
    ...
    public static void gameLoop(JButton playerChoice, JButton loseChoice, JButton winChoice, JFrame frame, JLabel nameLabel) {
        frame.getContentPane().removeAll();
        frame.repaint();
        ...
        resultLabel.setFont(new Font("Algerian", Font.BOLD | Font.ITALIC, 22));
        ...
        Timer timer = new Timer(2500, e -> {
            JButton computerPick = showComputerChoice(playerChoice, loseChoice, winChoice);
    ...
    public static JButton showComputerChoice(JButton playerChoice, JButton loseChoice, JButton winChoice){
        Random random = new Random();
        int computerPick = random.nextInt(3);
        switch(computerPick){
            case 0:
                loseChoice.setBounds(800, 250, 300, 300);
                return loseChoice;
            case 1:
                winChoice.setBounds(800, 250, 300, 300);
                return winChoice;
            case 2:
