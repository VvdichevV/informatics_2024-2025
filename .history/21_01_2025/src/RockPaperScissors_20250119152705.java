...
public class RockPaperScissors {
    ...
    public static void mainGame(JFrame frame) {
        ...
        rockButton.setBounds(100, 200, 300, 300);
        paperButton.setBounds(450, 200, 300, 300);
        scissorsButton.setBounds(800, 200, scaledWidth, scaledHeight);

        JLabel pickLabel = new JLabel("Pick your choice:");
        pickLabel.setFont(new Font("Algerian", Font.BOLD | Font.ITALIC, 22));
        nameLabel.setHorizontalAlignment(SwingConstants.CENTER);
        nameLabel.setBounds(450, 800, 300, 40);
