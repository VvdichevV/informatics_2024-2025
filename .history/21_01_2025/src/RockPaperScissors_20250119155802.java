...
public class RockPaperScissors {
    ...
    public static void mainGame(JFrame frame, JLabel nameLabel) {
        ...
        rockButton.addActionListener(e -> gameLoop(rockButton, frame, nameLabel));
        paperButton.addActionListener(e -> gameLoop(paperButton, frame, nameLabel));
        scissorsButton.addActionListener(e -> gameLoop(scissorsButton, frame, nameLabel));
    }

    public static void gameLoop(JButton playerChoice, JFrame frame, JLabel nameLabel) {
        frame.getContentPane().removeAll();
        frame.repaint();
        ...
        Timer timer = new Timer(3000, e -> {
            // Put here what should happen after 3 seconds
            // For example, show the computer's choice
            showComputerChoice(frame, playerChoice, nameLabel);
    ...
    public static void showComputerChoice(frame, )
