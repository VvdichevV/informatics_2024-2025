...
public class RockPaperScissors {
    ...
    public static void mainGame(JFrame frame) {
        ...
        Image rock = (new ImageIcon("21_01_2025\\src\\scissors.png")).getImage().getScaledInstance(300, 300, Image.SCALE_SMOOTH);
        ImageIcon rockIcon = new ImageIcon(rock); = new ImageIcon(scissors);
