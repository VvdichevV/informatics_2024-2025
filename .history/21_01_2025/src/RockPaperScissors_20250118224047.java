...
public class RockPaperScissors {
    ...
    public static void mainGame(JFrame frame) {
        ...
        Image scissors = (new ImageIcon("21_01_2025\\src\\scissors.png")).getImage().getScaledInstance(300, 300, Image.SCALE_SMOOTH);
        ImageIcon scissorsIcon = new ImageIcon(scissors);

        Image rock = (new ImageIcon("21_01_2025\\src\\rock.png")).getImage().getScaledInstance(300, 300, Image.SCALE_SMOOTH);
        ImageIcon rockIcon = new ImageIcon(rock);

        Image paper = (new ImageIcon("21_01_2025\\src\\scissors.png")).getImage().getScaledInstance(300, 300, Image.SCALE_SMOOTH);
        ImageIcon paperIcon = new ImageIcon(scissors);
