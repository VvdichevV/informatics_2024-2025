...
public class Vicosaurus extends JPanel implements ActionListener, KeyListener {
    ...
    int score = 0;
    int highScore = 0;
    String highScoreFile = "11_06_2025/src/highscore.txt";
    ...
    public void draw(Graphics g) {
        ...
        if(gameOver){
            g.drawString("Game Over! Score: " + score + " | High Score: " + highScore, 10, 35);
        } else {
    ...
    private void saveHighScore() {
        try {
            ...
            writer.close();
            System.out.println("High score saved to: " + file.getAbsolutePath());
        } catch (IOException e) {
