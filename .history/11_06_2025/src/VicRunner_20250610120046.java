...
public class VicRunner {
    public static void main(String[] args) {
        ...
        ImageIcon gifIcon = new ImageIcon(VicRunner.class.getResource("title.gif"));
        Image scaledImage = gifIcon.getImage().getScaledInstance(1000, 500, Image.SCALE_SMOOTH); // Adjust size as needed
ImageIcon scaledGifIcon = new ImageIcon(scaledImage);

JLabel titleLabel = new JLabel(scaledGifIcon);
titleLabel.setHorizontalAlignment(SwingConstants.CENTER);
titleLabel.setBounds(100, 50, 1000, 500); // Adjust bounds to match new size
