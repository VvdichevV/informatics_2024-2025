...
public class Victorium {
    public static void main(String[] args) {
        ...
        ImageIcon gifIcon = new ImageIcon("11_06_2025/src/title.gif");
    ...
    public static void buttonStyle(JButton button) {
        ...
        // Update the ImageIcon path to use getResource to load from classpath
ImageIcon gifIcon = new ImageIcon(Victorium.class.getResource("/title.gif"));

// Add error handling in case gif cannot be loaded
if (gifIcon.getImageLoadStatus() != MediaTracker.COMPLETE) {
    System.err.println("Error loading title.gif");
    gifIcon = new ImageIcon(); // Empty image icon as fallback
}
