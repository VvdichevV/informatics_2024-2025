...
public class Victorium {
    ...
    public static void buttonStyle(JButton button) {
        ...
        // Store original bounds (create a new Rectangle to avoid reference issues)
        Rectangle originalBounds = new Rectangle(button.getBounds());
        ...
        button.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                ...
                // Stop shrink animation if running
            ...
            public void mouseExited(java.awt.event.MouseEvent evt) {
                ...
                // Stop grow animation if running
